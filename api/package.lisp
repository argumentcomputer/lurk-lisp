...
(defpackage lurk.api
  ...
  (:export #:atom #:car #:cdr #:cons #:current-env #:eq #:define #:defmacro #:if #:lambda #:let #:letrec #:nil #:quote #:t #:+ #:- #:* #:/ #:=))
...
(defpackage lurk.api.impl
  ...
  (:shadow #:atom #:eval)
  (:export #:eval #:eval-expr #:empty-env #:empty-ram #:make-evaluator #:*default-p*))
